...
export const metadata: Metadata = {
  title: "Terms of Service | Ayodeji Anifowose Store",
  description:
    "Read the terms of service for purchasing physical products, books, eBooks, and digital media at Ayodeji Anifowose Store.",
}
      ...
      <div className="content-container max-w-3xl">
        ...
        <div className="prose prose-sm max-w-none text-[#4D4C4C] space-y-8 leading-relaxed text-xs sm:text-sm">
          <section className="space-y-3">
            ...
            <p>
              By accessing our website, creating an account, or purchasing any physical products or digital editions from Ayodeji Anifowose Store, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use our services.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              When you purchase an eBook or Audiobook from our store, you are granted a non-exclusive, non-transferable, revocable license to access, stream, and read the content strictly for personal, non-commercial use.
            </p>
          ...
          <section className="space-y-3">
            ...
            <p>
              All product designs, book titles, written content, audio recordings, cover illustrations, typography, logos, and digital designs are the exclusive intellectual property of author Ayodeji Anifowose and protected by international copyright laws. All rights not expressly granted are reserved.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="text-base sm:text-lg font-bold text-[#382C2C]">4. Physical Orders & Fulfillment</h2>
            <p>
              Orders for physical merchandise and print editions are subject to product availability. We strive to provide accurate shipping estimates and tracking information. Risk of loss and title for physical items pass to you upon delivery to the carrier.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              We reserve the right to update these terms at any time. Continued use of our store after modifications constitute acceptance of the updated terms.
            </p>
            <p>
