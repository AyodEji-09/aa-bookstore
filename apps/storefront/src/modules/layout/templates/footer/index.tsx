    ...
    <footer className="w-full bg-[#980000] text-white">
      ...
      <div className="content-container py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Column 1: Categories */}
          <div>
            <h4 className="font-bold text-sm text-white/90 mb-4">
              Categories
            </h4>
          ...
          {/* Column 2: Customer Service / Information */}
          <div>
            <h4 className="font-bold text-sm text-white/90 mb-4">
              Help & Information
            </h4>
            <ul className="space-y-2.5 text-xs text-white/80">
              <li>
                <a
                  href="https://ayodejianifowose.com"
                  target="_blank"
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-white/70">
          ...
          <div className="flex items-center gap-x-4">
            ...
            <a
              href="https://instagram.com/ayodeji.anifowose"
              target="_blank"
              rel="noreferrer"
              className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-colors"
              title="Follow Ayodeji Anifowose on Instagram"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a
              href="https://x.com/GFatherGHusband"
              target="_blank"
              rel="noreferrer"
              className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-colors"
              title="Follow Ayodeji Anifowose on X"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
            <div>
              © {new Date().getFullYear()} AYODEJI ANIFOWOSE STORE. All rights reserved.
            </div>
          ...
          {/* Payment Badges (SVG icons from /public/icons) */}
